"""
Модуль содержит класс генотипа параметров бота. Параметры для каждого
бота генерируются рандомно в допустимых интервалах в зависимости от биома,
которому принадлежит бот.
"""
